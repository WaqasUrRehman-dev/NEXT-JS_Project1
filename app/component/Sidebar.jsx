"use client";
import { LuBarChart, LuBrush, LuWrench } from "react-icons/lu";
...
const Sidebar = ({ isOpen, setIsOpen }) => {
  ...
  return (
    <aside
      className={`flex h-screen w-64 flex-col overflow-y-auto border-r bg-black px-5 py-8 transition-all duration-500 ${
        isOpen ? `transition-x-0` : ` w-0 -translate-x-72`
      } `}
    >
        ...
        <nav className="-mx-3 space-y-6 ">
          <div className="space-y-3 ">
            ...
            <Link
              ...
              href="/dashboard"
            >
              <LuBarChart className="h-5 w-5" aria-hidden="true" />
          ...
          <div className="space-y-3 ">
            ...
            >
              <HiOutlineNewspaper className="h-5 w-5" aria-hidden="true" />
            ...
            >
              <GoPaperclip className="h-5 w-5" aria-hidden="true" />
          ...
          <div className="space-y-3 ">
            ...
            >
              <LuBrush className="h-5 w-5" aria-hidden="true" />
            ...
            >
              <LuWrench className="h-5 w-5" aria-hidden="true" />
